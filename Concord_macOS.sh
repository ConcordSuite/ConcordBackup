...
cd /
tput setaf 7; clear && echo Running Concord v1.3 | tee Users/$SUDO_USER/Desktop/ScriptProgress.log
sleep 2
echo '' | tee -a Users/$SUDO_USER/Desktop/ScriptProgress.log
